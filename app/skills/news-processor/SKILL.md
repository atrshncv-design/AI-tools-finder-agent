...
**Критерии Tech (ИИ-инструменты) — VELOCITY, не абсолютные цифры:**
| Метрика | Баллы |
|---|---|
| Проект в GitHub Trending (свежий репо, активно набирает звёзды) | +40 |
| ИЛИ крупный проект (>10k⭐) со СВЕЖИМ релизом/тегом ≤72ч | +40 |
| HN пост или Reddit пост > 100 апвоутов | +30 |
| Открытая лицензия MIT / Apache-2.0 | +20 |

> Абсолютный критерий «>20k звёзд» упразднён: он протаскивал старые
> признанные проекты. Теперь пишем либо о новых стартапах в тренде,
> либо о свежих обновлениях признанных инструментов.
