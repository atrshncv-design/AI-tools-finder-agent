...
## Дополнение (26.08.2026)

Whisper-вопрос закрыт владельцем («Эти вопросы закрываем»): GROQ_API_KEY
на прод добавляться не будет (по крайней мере сейчас). 157 отклонённых
за 14 дней видео остаются отклонёнными — это осознанное решение, не дефект.
